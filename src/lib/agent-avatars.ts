...
// Map known agent IDs to portraits
const AGENT_ID_MAP: Record<string, string> = {
  "momentum-bot":  STITCH_AVATARS.striker,   // Striker / cyan / net dominator
  "mean-revert":   STITCH_AVATARS.phantom,   // Phantom / purple / counter
