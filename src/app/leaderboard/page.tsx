...
export default async function LeaderboardPage() {
  ...
  const rankColors = ["#ffe6aa", "#c0c0c0", "#cd7f32"];
    ...
    <SiteChrome activeHref="/leaderboard">
      <div className="pt-20 pb-24 xl:pl-72 px-4 md:px-8 max-w-[1600px] mx-auto min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="p-4 flex flex-col justify-center border-l-4" style={{ background: '#1d1f2b', borderColor: '#ffe6aa' }}>
            <div className="text-[10px] font-mono uppercase" style={{ color: '#ffe6aa' }}>Total Prize Pool</div>
            <div className="text-2xl font-black font-mono" style={{ color: '#ffe6aa' }}>42,900.50 CR</div>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {rank === 1 && (
                        <span className="material-symbols-outlined text-lg" style={{ color: '#ffe6aa', fontVariationSettings: "'FILL' 1" }}>workspace_premium</span>
                      )}
                    </div>
